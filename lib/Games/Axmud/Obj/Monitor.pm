...
#
#
# Games::Axmud::Obj::Monitor
# Handles monitored objects

{ package Games::Axmud::Obj::Monitor;
    ...
    sub new {
        ...
        # Prepare a new instance of the monitored model object (used by the Inventory/Condition
        #   tasks)
        #
        # Expected arguments
